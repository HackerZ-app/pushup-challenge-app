...
/**
 * Dashboard Page - Main workout tracking interface for authenticated users
 */
const DashboardPage = () => {
  ...
  return (
    ...
    >
          ...
          {isChallengeComplete ? (
            ...
            >
              ...
              <motion.button
                ...
                className="px-8 py-3 bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-bold rounded-xl shadow-xl"
              >
                Start Over?
              </motion.button>
            </motion.div>
      ...
      <p className="mt-12 mb-6 text-gray-400 text-sm font-medium text-center">
